...
import (
	...
	context "context"
	errors "errors"
	users "github.com/az58740/connect-go-server/users"
	http "net/http"
	strings "strings"
)
...
const (
	...
	UsersServiceLoginProcedure = "/users.UsersService/Login"
)
...
type UsersServiceClient interface {
	Login(context.Context, *connect.Request[users.LoginRequest]) (*connect.Response[users.UserResponse], error)
}
...
func NewUsersServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UsersServiceClient {
	...
	return &usersServiceClient{
		login: connect.NewClient[users.LoginRequest, users.UserResponse](
			httpClient,
...
type usersServiceClient struct {
	login *connect.Client[users.LoginRequest, users.UserResponse]
}

// Login calls users.UsersService.Login.
func (c *usersServiceClient) Login(ctx context.Context, req *connect.Request[users.LoginRequest]) (*connect.Response[users.UserResponse], error) {
...
func (UnimplementedUsersServiceHandler) Login(context.Context, *connect.Request[users.LoginRequest]) (*connect.Response[users.UserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("users.UsersService.Login is not implemented"))
}
